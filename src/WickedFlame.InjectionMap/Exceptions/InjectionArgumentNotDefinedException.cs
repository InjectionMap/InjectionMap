...
{
    public class InjectionArgumentNotDefinedException : Exception
    {
        public InjectionArgumentNotDefinedException(Type argumentType, Type mappableType) :
        ...
        public InjectionArgumentNotDefinedException(Type argumentType, Type mappableType, string message) :
            base(message)
        {
            ArgumentType = argumentType;
            MappableType = mappableType;
